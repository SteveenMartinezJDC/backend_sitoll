...
class DepartamentoRuta {
    ...
    cargarRutas() {
        ...
        this.apiRutaDepartamento.get("/list", departamentoControlador_1.default.listarDepartamentos);
        ...
        this.apiRutaDepartamento.get("/one/:codDepartamento", departamentoControlador_1.default.listarDepartamentos);
    }
}
