...
let Peaje = class Peaje {
    constructor(cod, codR, nom, fotoPu, fotoPri) {
        this.codPeaje = cod;
...
__decorate([
    (0, typeorm_1.OneToMany)(() => puesto_1.default, (objtPuesto) => objtPuesto.codPeajeP),
    __metadata("design:type", Array)
], Peaje.prototype, "puestos", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => ruta_1.default, (ruta) => ruta.peajes, { onDelete: "RESTRICT", onUpdate: "CASCADE" }),
